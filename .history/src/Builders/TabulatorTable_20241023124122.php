...
class TabulatorTable
{
    ...
    public function render()
    {
        ...
        file_get_contents(/var/www/html/packages/Nano112/livewire-tabulator/src/resources/views/tabulator-table.blade.php): Failed to open stream: No such file or directory
