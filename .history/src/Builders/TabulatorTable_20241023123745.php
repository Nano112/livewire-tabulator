...
class TabulatorTable
{
    ...
    public function render()
    {
        ...
        //list the content 
        dump($path);
        dd(scandir("/var/www/html/packages/Nano112/livewire-tabulator/src/../src/resources/views", SCANDIR_SORT_DESCENDING));
        
        return view('livewire-tabulator::resources.tabulator-table', [
            'data'    => $this->data,
